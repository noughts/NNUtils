...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       An optional longer description of NNUtils

                       * Markdown format.
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/NNUtils"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "koichi yamamoto" => "koichi@dividual.jp" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/NNUtils.git", :tag => s.version.to_s }
